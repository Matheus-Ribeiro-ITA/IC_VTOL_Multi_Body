...
function [Mat_X_eq,Mat_U_eq, Mat_Y_eq, Mat_V_eq] = uni_body_CG(cg)
%% --------------------------------------------------------------------------------
% Aircraft Parameters and Functions
% ---------------------------------------------------------------------
addpath ..\
addpath ..\Sub_functions
addpath ..\Trim_results_uni_body
addpath ..\Aircraft_data
addpath ..\Timagem_uni_body
...
options = optimset('Display','iter','TolFun',1e-10,'TolX',5e-5);
fun= @(alpha_eq)( trim_fun_fminse_uni_body(alpha_eq,V_eq,aircraft,trim_par,ini_0));
A=[];
b=[];
Aeq=[];
beq=[];
...
[~,X_eq,U_eq,Y_eq] = trim_fun_fminse_uni_body(alpha_eq,V_eq,aircraft,trim_par,ini_0);
