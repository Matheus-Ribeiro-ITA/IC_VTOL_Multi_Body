% -------------------------------------------------------
% Multi Body Dynamics (INCORRET EQUATIONS)
% -------------------------------------------------------
% Author: Matheus Ribeiro T-21
% gmail: matehus.ribeiro.aer@gmail.com
% Version: 0.0.1 
% Description: Aircraft Multi-Body dynamics. It was noticed a mistake
%               on equation that will be corrected on the future.
% -------------------------------------------------------
...
V_dot_02=-omega_B*V+F_B/m_total + C_bv*g - F;
