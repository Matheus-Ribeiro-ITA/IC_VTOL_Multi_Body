...
simout = sim(modelname,'StopTime','50')

T = simout.get('tout');
X = simout.get('logsout').get('X').Values.Data;
Y = simout.get('logsout').get('Y').Values.Data;
U = simout.get('logsout').get('U').Values.Data;
